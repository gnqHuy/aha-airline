        ...
        <div className = {sectionTab === "checkIn" ? (prevTab === "default" ? "bookingSection_checkIn_container fadeIn focusedDiv medium:w-[90vw] medium:left-[1%] small:w-[90vw] small:left-[1%] small:h-[29rem] big:w-[78vw]" : "bookingSection_checkIn_container focusedDiv medium:w-[90vw] medium:left-[1%] small:w-[90vw] small:left-[1%] small:h-[29rem] big:w-[78vw]") : "bookingSection_checkIn_container fadeIn"}>
            ...
            {activeOption === "reservationCode" && <div className = "options_input_reservationCode">
                <div className = "relative left-[2rem] top-[4rem]">
                    ...
                    <div>
                        <input type = "text" className = "w-[18rem] medium:w-[26vw] small:w-[35vw] text-sm" onFocus = {() => setFocusReservationCode(true)} onBlur = {() => setFocusReservationCode(false)}/>
                    </div>
                </div>
                <div className = "relative left-[16rem] top-[4rem]">
                    ...
                    <div>
                        <input type = "text" id = "options_input_familyName" className = "w-[18rem] medium:w-[26vw] small:w-[35vw]" onFocus = {() => setFocusName(true)} onBlur = {() => setFocusName(false)}/>
                    </div>
                </div>
            ...
            {activeOption === "eTicket" && <div className = "options_input_reservationCode">
                <div className = "relative left-[2rem] top-[4rem]">
                    ...
                    <div>
                        <input type = "text" className = "w-[18rem] medium:w-[26vw] small:w-[35vw]" onFocus = {() => setFocusEticket(true)} onBlur = {() => setFocusEticket(false)}/>
                    </div>
                </div>
                <div className = "relative left-[16rem] top-[4rem]">
                    <div className = "relative top-[1.5rem]">
            ...
            {activeOption === "flyerNumber" && <div className = "options_input_reservationCode">
                <div className = "relative left-[2rem] top-[4rem]">
                    ...
                    <div>
                        <input type = "text" className = "w-[18rem] medium:w-[26vw] small:w-[25vw]" onFocus = {() => setFocusReservationCode(true)} onBlur = {() => setFocusReservationCode(false)}/>
                    </div>
                </div>
                ...
                <div className = "relative left-[15rem] top-[4rem]">
                    ...
                    <div>
                        <input type = "text" id = "options_input_familyName" className = "w-[18rem] medium:w-[26vw] small:w-[25vw]" onFocus = {() => setFocusName(true)} onBlur = {() => setFocusName(false)}/>
                    </div>
                </div>
                ...
                <div className = "relative left-[16rem] top-[4rem]">
                    ...
                    <div>
                        <input type = "text" id = "options_input_familyName" className = "w-[18rem] medium:w-[26vw] small:w-[25vw]" onFocus = {() => setFocusProgram(true)} onBlur = {() => setFocusProgram(false)}/>
                    </div>
                </div>
