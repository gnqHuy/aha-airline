...
const BookingSectionHeader: React.FC<Props> = ({handleChangeTab, sectionTab}) => {
  return (
    <div className = "bookingSectionHeaderContainer">
        <div className = {sectionTab === "book" ? "bookingSectionHeaderItem hoverItem" : "bookingSectionHeaderItem"} onClick={() => handleChangeTab("book")}>
        ...
        <div className = {sectionTab === "manageBooking" ? "bookingSectionHeaderItem hoverItem" : "bookingSectionHeaderItem"} onClick={() => handleChangeTab("manageBooking")}>
