...
const BookingContentOneWay: React.FC<Props> = ({handleSetupDisplaySuggestion, handleSetupDisplaySuggestionTo, handleSetupDisplayCalendarDepart, handleSetupDisplayPassengerInfo, adultPassengerQuantity, childrenPassengerQuantity, infantPassengerQuantity, handleChangeSearchingAirport, handleChangeSearchingAirportTo, displaySuggestion, displaySuggestionTo, selectedAirport, selectedAirportTo, selectedDateDepart}) => {
  return (
    <div className = "flex">
