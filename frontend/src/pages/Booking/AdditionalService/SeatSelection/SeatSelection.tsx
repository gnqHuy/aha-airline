...
const SeatSelection = (props: Props) => {
  return (
    <div className = "w-[70rem]">
        ...
        <div>
            <div className = "flex">
                <div className = "w-[11rem] h-[3rem] bg-[#ebc94e] text-center  border-x-[1px] border-y-[1px] border-solid border-white">
                    <p></p>
                </div>
                <div className = "w-[11rem] h-[3rem] bg-[#ebc94e] text-center  border-x-[1px] border-y-[1px] border-solid border-white">
            ...
            <div className = "flex">
                <div className = "w-[11rem] h-[3rem] bg-[#b3afaf] text-center  border-x-[1px] border-y-[1px] border-solid border-white">
                    <p className = "text-lg font-bold relative top-[-0.5rem]">Economy Flex</p>
                </div>
                <div className = "w-[11rem] h-[3rem] bg-[#1A4532] text-center  border-x-[1px] border-y-[1px] border-solid border-white">
