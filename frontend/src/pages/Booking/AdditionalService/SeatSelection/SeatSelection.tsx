...
const SeatSelection = (props: Props) => {
  return (
    <div className = "w-[70rem]">
        <p className = "font-space-grotesk text-3xl text-[#094c5b] font-bold">Seat Selection</p>
        ...
        <div>
            <p className = "font-space-grotesk text-2xl text-[#094c5b] font-bold">For Domestic route</p>
        ...
        <div>
            ...
            <div className = "flex">
                ...
                <div className = "w-[11rem] h-[3rem] bg-[#094c5b] text-center font-space-grotesk border-x-[1px] border-y-[1px] border-solid border-white">
        ...
        <div className = "relative top-[2rem] font-space-grotesk">
            <p className = "text-2xl text-[#094c5b] font-bold">Seating details</p>
