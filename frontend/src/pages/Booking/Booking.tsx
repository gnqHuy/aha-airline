    ...
    <Layout>
      ...
      <div className="flex flex-col items-center my-4">
        <div className="flex justify-center items-center my-4 gap-4">
          <GenericCard image={image6} title={"Online Booking"} link={"/explore/experience"} />
          <GenericCard image={image7} title={"Booking Information"} link={"/explore/offer"} />
        </div>
        <GenericCard image={image2} title={"Additional Service"} link={"/explore/destination"} width={"1016px"} />
      </div>
    </Layout>
  );
};
