        ...
        <div className="relative overflow-x-clip overflow-y-auto bg-slate-50">
            ...
            <div className="relative w-[75vw] mx-auto mt-4">
                ...
                <div className="relative mt-8" id="online">
                    ...
                    <p className="text-xl text-Green font-bold mt-4">Check-in online instructions</p>
                    ...
                    <p className="text-xl text-Green font-bold mt-6">Cases Where Online Check-in Is Not Applicable</p>
