        ...
        <div className = "relative bottom-[1.5rem]">
            <div className = "flex">
                ...
                <div className = "relative left-[1rem] bottom-[1.5rem]">
                    ...
                    <input id = "animated-input" type = "text" className = "w-[13rem] h-[2rem] bg-[#2c694e] relative bottom-[1rem] rounded-[15px] border-none outline-none text-white font-space-grotesk pl-[2%]" placeholder = "Your firstname"/>
                ...
                <div className = "relative left-[1rem] bottom-[1.5rem] ml-[2rem]">
                    ...
                    <input id = "animated-input" type = "text" className = "w-[14rem] h-[2rem] bg-[#2c694e] relative bottom-[1rem] rounded-[15px] border-none outline-none text-white font-space-grotesk pl-[2%]" placeholder = "Your lastname"/>
                    <div className = "h-[0.1rem]">
                        <p className = "text-sm font-bold relative left-[0.5rem] text-red-500 bottom-[1.5rem]">Error</p>
                    </div>
                </div>
            ...
            <div className = "relative left-[1rem] bottom-[3rem]">
                ...
                <input id = "animated-input" type = "text" className = "w-[29rem] h-[2rem] bg-[#2c694e] relative bottom-[1rem] rounded-[15px] border-none outline-none text-white font-space-grotesk pl-[2%]" placeholder = "Your e-mail"/>
                <div className = "h-[0.1rem]">
                    <p className = "text-sm font-bold relative left-[0.5rem] text-red-500 bottom-[1.5rem]">Error</p>
                </div>
            </div>
            ...
            <div className = "relative left-[1rem] bottom-[4.5rem]">
                ...
                <input id = "animated-input" type = "text" className = "w-[29rem] h-[2rem] bg-[#2c694e] relative bottom-[1rem] rounded-[15px] border-none outline-none text-white font-space-grotesk pl-[2%]" placeholder = "Your username"/>
                <div className = "h-[0.1rem]">
                    <p className = "text-sm font-bold relative left-[0.5rem] text-red-500 bottom-[1.5rem]">Error</p>
                </div>
            </div>
            ...
            <div className = "relative left-[1rem] bottom-[6rem]">
                ...
                <input id = "animated-input" type = "password" className = "w-[29rem] h-[2rem] bg-[#2c694e] relative bottom-[1rem] rounded-[15px] border-none outline-none text-white font-space-grotesk pl-[2%]" placeholder = "Your password"/>
                <div className = "h-[0.1rem]">
                    <p className = "text-sm font-bold relative left-[0.5rem] text-red-500 bottom-[1.5rem]">Error</p>
                </div>
            </div>
